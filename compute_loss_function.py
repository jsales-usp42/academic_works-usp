# =============================================================================
# Script to compute the loss function to varying weights and bias values
# =============================================================================
...
print("Variations in weights (w) and bias (b):")
...
print("===========================================")
print("Small variations in bias (b):")
print("J(w=1, b=-6) =", total_cost(1, -6, x, y))
...
print("===========================================")
print("Small variations in weigths (w):")
